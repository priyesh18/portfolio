...
module.exports = {
    ...
    excludeFiles: [
        /\.(wp|ios).(scss)$/i,
        /(action-sheet|alert|backdrop|badge|checkbox|chip|datetime|infinite-scroll|input|label|loading|modal|note|picker|popover|radio|range|refresher|searchbar|segment|select|slides|spinner|tabs|toast|toggle|virtual-scroll|cordova)/i,
    ],
